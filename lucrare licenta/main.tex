...
\gappto\captionsromanian{\renewcommand{\tablename}{Tabel}}
...
% Metadate
\title{Mini PC folosind modulul LattePanda Mu}
\author{Bălan Liviu-Florin}
...
\begingroup
\renewcommand{\addvspace}[1]{} % Anulează spațiul vertical dintre capitole
\listoffigures
\endgroup
